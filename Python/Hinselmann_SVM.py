...
data = pd.read_csv('Hinselmann_Test.csv', low_memory=False)
target = data["Hinselmann"]

testing_data = pd.read_csv('Hinselmann.csv',low_memory=False)
#target = testing_data["Hinselmann"]

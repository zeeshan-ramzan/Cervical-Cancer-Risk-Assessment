...
data = pd.read_csv('Complete_Hinselmann.csv', low_memory=False)


pdata = data[data.Hinselmann == 1]
ndata = data[data.Hinselmann == 0]
...
test_target = full_test_data["Hinselmann"]

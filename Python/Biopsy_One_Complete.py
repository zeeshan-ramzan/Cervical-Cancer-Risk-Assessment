...
data = pd.read_csv('Complete_Biopsy.csv', low_memory=False)


pdata = data[data.Biopsy == 1]
ndata = data[data.Biopsy == 0]
...
test_target = full_test_data["Biopsy"]
...
train_target= test_target[1:25]
test_target = test_target[10:34]
